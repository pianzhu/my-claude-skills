...
- Break system into 5-7 high-level modules
...
- Output: Generate a Mermaid.js Flowchart or SVG
...
Verify new architecture from two distinct altitudes:
1. **Macro (CEO View):** Does architecture strictly serve Phase 0 Metrics? Does it fit ecosystem?
2. **Micro (Engineer View):** Pick riskiest "gear" (function/API) and describe exactly how it turns
- Output: Brief "Alignment Check" paragraph
